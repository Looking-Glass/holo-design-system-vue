    ...
    >
      <div class="absolute inset-0 overflow-hidden">
        <div class="absolute inset-0 bg-gray-500 bg-opacity-75 transition-opacity z-40" @click="dialog = false">
          <div class="fixed top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 pl-10 max-w-full flex z-50">
            <div class="w-screen max-w-md">
              <div class="h-full flex flex-col p-6 rounded-md bg-white shadow-xl overflow-y-scroll">
                <slot></slot>
