<template>
  ...
  >
    ...
    <div class="w-56 rounded-md shadow-lg bg-black text-white ring-1 ring-white ring-opacity-5 focus:outline-none divide-y divide-gray-800" :class="{ 'absolute right-0' : right }">
      <slot />
    </div>
  </VDropdown>
</template>
